<div id="checklist-form-search" class="container checklist-form-search">
    <h5 class="title"> <i class="fa fa-pagelines"></i> Buscador Plantas CheckList (GPEC) </h5>
    <section >
            ...
            <div class="col-md-12 my-hidden advance-fields" id="advance-fields">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" id="species_name" name="species_name" placeholder="Species Name">
                    </div>
                    <div class="col-md-4">
                        <label for=""> Species Genus</label>
                        <input class="form-control" id="species_genus" name="species_genus" placeholder="Genus">
                    </div>
                    <div class="col-md-4">
                        <label for="">Species Class</label>
                        <input class="form-control" id="species_class" name="species_class" placeholder="Class">
                    </div>
                    <div class="col-md-4">
                        <label for="">Species Infra Name </label>
                        <input class="form-control" id="syn_infra_name" name="syn_infra_name" placeholder="Class">
                    </div>
                    <div class="col-md-4">
                        <label for="">synonyms Infra Rank Name</label>
                        <input class="form-control" id="syn_infra_rank" name="syn_infra_rank" placeholder="">
                    </div>
                    <div class="col-md-4">
                        <label for="">synonyms Infra Rank2 Name</label>
                        <input class="form-control" id="syn_infra_rank2" name="syn_infra_rank2" placeholder="">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <?= $obj->get_combo_data("gpec_species","species_origen","--Seleccione Origin --","sel_species_origen"); ?>
                    </div>
                    <div class="col-md-4">
    ...
    <section>
        <?php if (  isset($_POST["myInput"]) or isset($_REQUEST['pag'])  ) {
            ...
            $sql = "SELECT SQL_CALC_FOUND_ROWS id, species_classname,species_ordername ,species_family,
                    species_genus,species_name,species_htmlname, species_plant_growth_form FROM gpec_species $addsql LIMIT $limit OFFSET $offset";
                ...
                <tr>
                    ...
                    for($i=0; $i< $maximo ;$i++){ ?>
                        <tr>
                            <td>
                                <h6>
                                    <a href="<?php echo get_site_url(add_query_arg(array($_GET), $wp->request))."/hello-gpec/?id={$query[$i]->id}" ?>">
